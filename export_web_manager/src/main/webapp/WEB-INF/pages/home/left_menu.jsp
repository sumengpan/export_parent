        ...
        <ul class="sidebar-menu">
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    ...
                    <li id="sys-log">
                        <a href="${path}/system/syslog/toList.do" onclick="setSidebarActive(this)"  target="iframe">
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            <c:forEach items="${sessionScope.menus}" var="item2">
                                &lt;%&ndash;           一级菜单的ctype==0 二级菜单的ctype==1&ndash;%&gt;
                                &lt;%&ndash;           二级的parentId肯定与一级的moduleId是相等，才能显示在该菜单下面&ndash;%&gt;
